      ...
      <div class="space-y-2">
        <div>
          <div
            ...
            style="color: var(--z-text-md)"
          >
            Seed (codice per invitare)
          </div>
          <code
            class="block font-mono-z text-sm p-2 rounded"
            style="background: var(--z-bg-800)"
          >{{ createdSeed }}</code>
        </div>
        <div>
          <div
          ...
          <code
            class="block font-mono-z text-sm p-2 rounded"
            style="background: var(--z-bg-800); color: var(--z-blood-300)"
          >{{ createdMasterToken }}</code>
        </div>
      </div>
      <UButton
        size="lg"
